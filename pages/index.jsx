  ...
  return (
    <div className="root">
      <div className="flex max-[600px]:flex-col w-full">
        ...
        <p className="absolute bottom-[20px] right-[20px]">Crafted with 💜  by <span className="text-purple-500"><a href="https://github.com/chiragbadhe" target="_blank">@ch1rag</a></span></p>
